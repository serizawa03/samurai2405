<footer class="<?php lightning_the_class_name( 'site-footer' ); ?>">
	...
	<div class="container site-footer-copyright">
			<p>Copyright © 桜寿司 All Rights Reserved.</p>
	</div>
</footer> 

<div class="bg-slider">
    <div class="slide" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/img14.jpg);"></div>
    <div class="slide" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/img15.jpg);"></div>
    <div class="slide" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/img16.jpg);"></div>
    <div class="slide" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/img17.jpg);"></div>
</div>